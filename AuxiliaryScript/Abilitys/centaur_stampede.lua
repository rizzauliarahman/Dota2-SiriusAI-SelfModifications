...
--初始数据
local ability = bot:GetAbilityByName('centaur_stampede')
...
--技能释放功能
function X.Release(castTarget, castDesire)
	X.Compensation() 
	if castDesire['R'] ~= nil and castDesire['Q'] ~= nil and castDesire['W'] ~= nil
		and	castDesire['R'] > castDesire['Q']
		and castDesire['R'] > castDesire['W']
	then
