...
--初始数据
local ability = bot:GetAbilityByName('magnataur_skewer')
...
function X.Consider()
	...
	local nSpeed = ability:GetSpecialValueInt("skewer_speed");
	...
	then
		...
		return BOT_ACTION_DESIRE_HIGH, GetXUnitsTowardsLocation( loc, nCastRange );
	end
