...
function X.Consider()
	...
	if J.IsRetreating(bot) and ( bot:HasModifier("modifier_keeper_of_the_light_spirit_form") or bot:HasScepter() ) 
	then
		...
		do
			...
			then
				return BOT_ACTION_DESIRE_LOW, U.GetXUnitsInFront(400);
			end
		end
	end
