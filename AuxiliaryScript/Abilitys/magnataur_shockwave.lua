...
--初始数据
local ability = bot:GetAbilityByName('magnataur_shockwave')
...
function X.Consider()
	...
	local nDamage = ability:GetSpecialValueInt("shock_damage");
	local nSpeed = ability:GetSpecialValueInt("shock_speed");
