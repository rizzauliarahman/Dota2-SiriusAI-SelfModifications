...
--初始数据
local ability = bot:GetAbilityByName('alchemist_unstable_concoction')
local nKeepMana, nMP, nHP, nLV, hEnemyHeroList, hAlleyHeroList;

if bot.CCStartTime == nil then bot.CCStartTime = 0 end
...
function X.Consider()
	...
	local nDamage = ability:GetSpecialValueInt( "max_damage" );
