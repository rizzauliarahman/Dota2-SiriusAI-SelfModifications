...
--初始数据
local ability = bot:GetAbilityByName('slark_dark_pact')
local abilityPC = bot:GetAbilityByName('slark_pounce')
...
function X.Consider()
	...
	local nDamage = ability:GetSpecialValueInt( "total_damage" );
