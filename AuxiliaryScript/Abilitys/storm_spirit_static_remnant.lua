...
--初始数据
local ability = bot:GetAbilityByName('storm_spirit_static_remnant')
...
function X.Consider()
	...
	local nRadius = ability:GetSpecialValueInt("static_remnant_radius");
	...
	then
		...
		if tableNearbyEnemyCreeps ~= nil and #tableNearbyEnemyCreeps >= 3 and nMP > 0.65 then
			return BOT_ACTION_DESIRE_MODERATE;
		end
	end
