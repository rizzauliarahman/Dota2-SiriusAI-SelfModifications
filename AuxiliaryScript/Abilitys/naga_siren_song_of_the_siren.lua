...
--初始数据
local ability = bot:GetAbilityByName('naga_siren_song_of_the_siren')
...
function X.Consider()
	...
	then
		...
		if ( J.IsValidHero(npcTarget) and J.CanCastOnNonMagicImmune(npcTarget) and not J.IsInRange(npcTarget, bot, 800) and J.IsInRange(npcTarget, bot, 1300) ) 
		then
