...
--初始数据
local ability = bot:GetAbilityByName('weaver_shukuchi')
...
function X.Consider()
	...
	then
		...
		if J.IsValidHero(npcTarget) and J.CanCastOnMagicImmune(npcTarget) and not J.IsInRange(npcTarget, bot, nAttackRange+200) and 
		   J.IsInRange(npcTarget, bot, 2000)
		then
