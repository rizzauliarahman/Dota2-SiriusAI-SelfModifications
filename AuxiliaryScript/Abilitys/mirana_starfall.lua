...
--初始数据
local ability = bot:GetAbilityByName('mirana_starfall')
...
function X.Consider()
   ...
   -- Get some of its values
	local nCastRange = ability:GetSpecialValueInt( "starfall_radius" );
	local nRadius = ability:GetSpecialValueInt( "starfall_secondary_radius" );
