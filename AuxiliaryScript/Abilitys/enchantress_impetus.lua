...
--初始数据
local ability = bot:GetAbilityByName('enchantress_impetus')
...
function X.Consider()
	...
	then
		...
		if J.IsValidHero(npcTarget) and J.CanCastOnMagicImmune(npcTarget) and J.IsInRange(npcTarget, bot, nAttackRange + 200) 
		then
